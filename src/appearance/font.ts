...
export const setFontSize = function (args: string[]): boolean {
    let size = args[3]
    let units = 'px'
...
export const getFontSize = function (type: string): string {
    return settings.fontSizes[fieldMap[type]]
}

export const resetFont = (area: string) => {
